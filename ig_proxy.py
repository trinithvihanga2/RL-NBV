...
class InformationGainAdapter:
    def __init__(self):
        ...
        self.camera_id_sub = rospy.Subscriber(
            "camera_id_inner", Int32, self.camera_id_callback
        )
        ...
        self.model_cnt = 1
        # camera
        self.camera_id_update_pub = rospy.Publisher(
            "camera_id_update", Int32, queue_size=10
        )
